...
void ofApp::setup(){
	...
	wheat_vbo.setVertexData(&wheats[0].pos.x, 4,wheats.size(), GL_DYNAMIC_DRAW,sizeof(Wheat));
	wheat_vbo.setColorData(&wheats[0].color.x, wheats.size(), GL_DYNAMIC_DRAW, sizeof(Wheat));
	wheat_vbo.setAttributeData(4, &wheats[0].angle.x, 4, wheats.size(), GL_DYNAMIC_DRAW, sizeof(Wheat));	
...
void ofApp::mouseDragged(int x, int y, int button){
	...
	ofMatrix4x4 view_mat = glm::inverse(cam.getLocalTransformMatrix());
